"""DeepSeek GPT Service for DEIA - Simplified chat interface for LLM interaction.

⚠️ DEPRECATED: This service is deprecated in favor of llm_service.py which provides:
...
Usage (deprecated):
    ...
    service = DeiaGPTService(api_key="your-deepseek-key")
...
class DeiaGPTService:
    """Simplified GPT service for DEIA using DeepSeek API.

    This service provides basic chat functionality with DeepSeek's LLM,
    ...
    def __init__(
        ...
        Args:
            ...
            model: Model to use (default: "qwen2.5-coder:7b", also: "deepseek-coder-v2:16b")
...
if __name__ == "__main__":
    ...
    # For DeepSeek (cloud), use environment variable
    api_key = os.environ.get("DEEPSEEK_API_KEY") or os.environ.get("OPENAI_API_KEY") or "ollama"

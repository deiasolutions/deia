...
**Create and maintain:**
```
.deia/sessions/2025-10-27-SIMULATION-BOT-A.md
```
...
**File three reports to the hive:**

**Report 1: Task Acknowledgment (at START)**
```
.deia/hive/responses/deiasolutions/SIMULATION-BOT-A-ACKNOWLEDGED-2025-10-27.md
```
Content: Confirm you understand the task, your approach, timeline

**Report 2: Mid-Point Status (at 00:30)**
```
.deia/hive/responses/deiasolutions/SIMULATION-BOT-A-MIDPOINT-2025-10-27.md
```
Content: Progress so far, current score, adjustments made

**Report 3: Completion Report (at STOP)**
```
.deia/hive/responses/deiasolutions/SIMULATION-BOT-A-COMPLETE-2025-10-27.md
```
...
**Update continuously:**
```
.simulations/experiments/sessions/2025-10-27-0724-llm_challenge/Bot_A/WORKING-LOG.md
```
...
```
.simulations/experiments/sessions/2025-10-27-0724-llm_challenge/Bot_A/
...
- Bot C (separate independent track)
...
## How to Structure Your Acknowledgment Report

When judge says GO, file this to hive:

```markdown
# Bot A - Task Acknowledgment

**FROM:** Bot A (Claude)
**TO:** Q33N and Hive
**DATE:** 2025-10-27
**TIME:** [When judge says GO]

---

## Task Understood

Mission: Train Flappy Bird AI agent using classical RL

Approach: [Your chosen method - DQN, PPO, NEAT, etc.]

Timeline:
- 00:00-00:15: [Your plan]
- 00:15-00:30: [Your plan]
- 00:30-00:45: [Your plan]
- 00:45-01:00: [Your plan]

Deliverables:
- Trained model with score recorded
- Code with DEIA standards applied
- Documentation (README, ARCHITECTURE, RESULTS)

Protocols:
- [x] Auto-logging to .deia/sessions/
- [x] Hive reports at checkpoints
- [x] Working log in .simulations/
- [x] No communication with other bots
- [x] DEIA bee rules understood

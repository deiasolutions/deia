# ⚠️ DEPRECATED ANTI-PATTERN

**THIS DOCUMENT IS DEPRECATED AND ARCHIVED**

**Reason for deprecation:** The valuable insights from this anti-pattern have been merged into the authoritative documentation versioning guide.

**See instead:** `docs/best-practices/doc-versioning-process.md` - Section 4.4 "Why We Archive (Don't Delete)" (the authoritative source of truth)

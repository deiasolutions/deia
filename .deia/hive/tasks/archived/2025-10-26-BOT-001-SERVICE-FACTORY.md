# TASK: BOT-001 - Service Factory & Task Endpoint Integration

**Priority:** P1 BLOCKING
**Time Estimate:** 45 minutes
**Start:** NOW
**Blocker:** None - can start immediately
**Depends On:** Multi-Bot Type System (COMPLETE)

---

## OBJECTIVE

Enable the chat task endpoint to call actual LLM services based on bot_type. Create service factory and update task handling.
...
When finished, create: `.deia/hive/responses/deiasolutions/bot-001-service-factory-done.md`
